...
import { useProductColumns } from "./RentRequestsTableColumn";

export function RentRequestTable() {
  ...
  async function fetchRentalRequests() {
    const res = await rentService.getRentRequests(offset, 5, undefined, false);
